...
export class AddVideoTitleDescription1789209191828 implements MigrationInterface {
  name = 'AddVideoTitleDescription1789209191828';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "videos" ADD "title" character varying(200)`,
    );
